...
export class TicketsBlock extends ReduxMixin(PolymerElement) {
      ...
      <div class="tickets-wrapper container">
          ...
          <table class="comparison-table">
            <thead>
              <tr>
                ...
                <th class="supporter-col">
                  [[ticketsBlock.featureComparison.tierLabels.supporter]]
                </th>
              </tr>
            </thead>
            <tbody>
              <template
                is="dom-repeat"
                items="[[ticketsBlock.featureComparison.features]]"
                as="feature"
              >
                <tr class$="[[getExclusiveRowClass(feature)]]">
                  <td>[[feature.name]]</td>
                  <td>
                    <span class="check" hidden$="[[!hasTier(feature, 'scholarship')]]"
                      >&#10003;</span
                    >
                  </td>
                  <td>
                    <span class="check" hidden$="[[!hasTier(feature, 'earlybird')]]">&#10003;</span>
                  </td>
                  <td>
                    <span class="check" hidden$="[[!hasTier(feature, 'regular')]]">&#10003;</span>
                  </td>
        ...
        <div class="ticket-ctas" hidden$="[[_hideCtas(ticketsBlock)]]">
          ...
          <div class="group-discount" hidden$="[[!ticketsBlock.groupDiscountEmail]]">
            ...
            <a href$="mailto:[[ticketsBlock.groupDiscountEmail]]"
              >[[ticketsBlock.groupDiscountEmail]]</a
            >
  ...
  private getButtonText(available: boolean, scholarship: boolean) {
    return scholarship
      ...
      : available
        ? buyTicket
        : this.ticketsBlock.notAvailableYet;
  }

  private hasTier(feature: { name: string; tiers: string[] }, tier: string): boolean {
