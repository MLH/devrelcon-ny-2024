...
export const theme = css`
  :host {
    ...
    --box-shadow-primary-color:
      0 3px 3px -2px rgb(0 173 208 / 30%), 0 3px 4px 0 rgb(0 173 208 / 30%),
      0 1px 8px 0 rgb(0 173 208 / 30%);
    --box-shadow-primary-color-hover:
      0 1px 3px -2px rgb(0 173 208 / 40%), 0 4px 5px 0 rgb(0 173 208 / 40%),
      0 2px 9px 0 rgb(0 173 208 / 40%);
    --font-family:
