  ...
  override render() {
    ...
    return html`
      ...
      <div class="field">
        <sl-input
          label="Name"
          value="${(this.data['name'] as string) || ''}"
          required
          @sl-change=${(e: Event) => {
            const value = (e.target as HTMLInputElement).value;
            this.setField('name', value);
            if (this.isNew) this.docId = toSlug(value);
          }}
        ></sl-input>
      </div>
      <div class="field">
        <sl-input
          label="Job Title"
          value="${(this.data['title'] as string) || ''}"
      ...
      <div class="field">
        <sl-input
          label="Company"
          value="${(this.data['company'] as string) || ''}"
      ...
      <div class="field">
        <sl-input
          label="Country"
          value="${(this.data['country'] as string) || ''}"
      ...
      <div class="field">
        <sl-input
          label="Pronouns"
          value="${(this.data['pronouns'] as string) || ''}"
          placeholder="e.g. she/her"
          @sl-change=${(e: Event) =>
            this.setField('pronouns', (e.target as HTMLInputElement).value)}
        ></sl-input>
      </div>
      <div class="field">
        <sl-textarea
          label="Bio"
          value="${(this.data['bio'] as string) || ''}"
          rows="4"
      ...
      <div class="field">
        <sl-textarea
          label="Short Bio"
          value="${(this.data['shortBio'] as string) || ''}"
          rows="2"
          @sl-change=${(e: Event) =>
            this.setField('shortBio', (e.target as HTMLInputElement).value)}
        ></sl-textarea>
      </div>
      <div class="field">
        <admin-image-upload
          label="Photo"
          value="${(this.data['photoUrl'] as string) || ''}"
          collection="speakers"
      ...
      <div class="field">
        <sl-input
          label="Photo Path"
          value="${(this.data['photo'] as string) || ''}"
      ...
      <div class="field">
        <sl-input
          ...
          value="${(this.data['companyLogo'] as string) || ''}"
          @sl-change=${(e: Event) =>
            this.setField('companyLogo', (e.target as HTMLInputElement).value)}
        ></sl-input>
      </div>
      <div class="field">
        <admin-image-upload
          label="Company Logo"
          value="${(this.data['companyLogoUrl'] as string) || ''}"
          collection="speakers"
      ...
      <div class="field">
        <sl-input
          label="Display Order"
          type="number"
          value="${this.data['order'] ?? 0}"
          required
          @sl-change=${(e: Event) =>
            this.setField('order', Number((e.target as HTMLInputElement).value))}
        ></sl-input>
      </div>
      <div class="field">
        <sl-switch
          ?checked=${!!this.data['featured']}
          @sl-change=${(e: Event) =>
            this.setField('featured', (e.target as HTMLInputElement).checked)}
          >Featured</sl-switch
        >
      </div>
      <div class="field">
        <sl-switch
          ...
          @sl-change=${(e: Event) =>
            this.setField('active', (e.target as HTMLInputElement).checked)}
  ...
  private renderYearGroup(yg: YearGroup, yi: number) {
    return html`
      <div class="year-group">
        ...
        <div class="field">
          <sl-input
            label="Job Title (that year)"
            size="small"
            value="${yg.title}"
            @sl-change=${(e: Event) =>
              this.updateYearField(yi, 'title', (e.target as HTMLInputElement).value)}
          ></sl-input>
        </div>
        <div class="field">
          <sl-input
            label="Company (that year)"
            size="small"
            value="${yg.company}"
            @sl-change=${(e: Event) =>
              this.updateYearField(yi, 'company', (e.target as HTMLInputElement).value)}
          ></sl-input>
        </div>
        <div class="field">
          <sl-textarea
            ...
            rows="3"
            @sl-change=${(e: Event) =>
              this.updateYearField(yi, 'bio', (e.target as HTMLInputElement).value)}
          ></sl-textarea>
        </div>
        ${yg.talks.map(
          (session, si) => html`
            <div class="session-row">
              <div class="session-row-header">
                <sl-input
                  ...
                  value="${session.title}"
                  @sl-change=${(e: Event) =>
                    this.updateSession(yi, si, 'title', (e.target as HTMLInputElement).value)}
                ></sl-input>
                <sl-icon-button
                  name="x-lg"
                  label="Remove talk"
              ...
              <div class="session-details">
                <sl-input
                  ...
                  @sl-change=${(e: Event) =>
                    this.updateSessionTags(yi, si, (e.target as HTMLInputElement).value)}
                ></sl-input>
                <sl-input
                  size="small"
                  placeholder="Presentation URL"
                  value="${session.presentation || ''}"
                  @sl-change=${(e: Event) =>
                    this.updateSession(
                      yi,
                      si,
                ...
                <sl-input
                  ...
                  @sl-change=${(e: Event) =>
                    this.updateSession(yi, si, 'videoId', (e.target as HTMLInputElement).value)}
                ></sl-input>
              </div>
            </div>
          `,
