...
export class AdminPage extends LitElement {
  ...
  override render() {
    ...
    return html`
      <div class="layout">
        ...
        <div class="main">${this.renderContent()}</div>
      </div>
    `;
  }
  ...
  private renderSubcollectionSection(
    groupSchemaKey: string,
